...
use eigenda::cert::solidity::{SecurityThresholds, StakeUpdate, VersionedBlobParams};
use eigenda::verification::cert::bitmap::Bitmap;
use eigenda::verification::cert::hash::TruncHash;
use eigenda::verification::cert::types::history::{History, HistoryError};
use eigenda::verification::cert::types::{QuorumNumber, Stake, Version};
...
mod stale_stakes_forbidden {
    use eigenda::verification::cert::types::BlockNumber;
    use tracing::instrument;
