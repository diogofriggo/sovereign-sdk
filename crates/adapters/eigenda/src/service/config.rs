...
pub struct EigenDaContracts {
    ...
    /// # Details
    ///
    /// The `relayKeyToInfo` mapping is read from it. See [eigenda_cert_verifier::types::Storage]'s `relay_key_to_relay_address`
    ...
    /// # Details
    ///
    /// The `versionedBlobParams` mapping is read from it. See [eigenda_cert_verifier::types::Storage]'s `versioned_blob_params`
    ...
    /// The _operatorBitmapHistory mapping is read from it. See [eigenda_cert_verifier::types::Storage]'s `operator_bitmap_history`
    /// The quorumUpdateBlockNumber mapping is read from it. See [eigenda_cert_verifier::types::Storage]'s `quorum_update_block_number`
    ...
    /// # Details
    ///
    /// The staleStakesForbidden variable is read from it. See [eigenda_cert_verifier::types::Storage]'s `stale_stakes_forbidden`
    ...
    /// # Details
    ///
    /// The minWithdrawalDelayBlocks variable is read from it. See [eigenda_cert_verifier::types::Storage]'s `min_withdrawal_delay_blocks`
    ...
    /// # Details
    ///
    /// The apkHistory mapping is read from it. See [eigenda_cert_verifier::types::Storage]'s `apk_history`
    ...
    /// # Details
    ///
    /// The _totalStakeHistory mapping is read from it. See [eigenda_cert_verifier::types::Storage]'s `total_stake_history`
    /// The operatorStakeHistory mapping is read from it. See [eigenda_cert_verifier::types::Storage]'s `operator_stake_history`
    ...
    /// # Details
    ///
    /// The quorumNumbersRequiredV2 variable is read from it. See [crate::spec::CertVerificationInputs]'s `required_quorum_numbers`
    /// The securityThresholdsV2 variable is read from it. See [crate::spec::CertVerificationInputs]'s `security_thresholds`
