...
use eigenda::verification::cert::CertVerificationInputs;
use eigenda::verification::cert::types::Storage;
...
use crate::eigenda::extraction::{
    ApkHistoryExtractor, CertExtractionError, DataDecoder, NextBlobVersionExtractor,
    OperatorBitmapHistoryExtractor, OperatorStakeHistoryExtractor, QuorumCountExtractor,
    QuorumNumbersRequiredV2Extractor, SecurityThresholdsV2Extractor, TotalStakeHistoryExtractor,
...
impl CertificateStateData {
    ...
    pub fn extract(
        ...
        #[cfg(feature = "stale-stakes-forbidden")]
        let staleness = {
            use eigenda::verification::cert::types::Staleness;
